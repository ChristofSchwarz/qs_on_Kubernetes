...
The steps below will start keycloak as a K8s deployment and expose it as a NodePort service for your Minikube. If deployed on a production cluster, you may need the service type "LoadBalancer". In this case, edit the keycloak-depl+svc.yaml file first.
